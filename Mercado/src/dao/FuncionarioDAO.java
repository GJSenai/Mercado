...
public class FuncionarioDAO {
    ...
    public ArrayList<Funcionario> read() {
        ...
        try {
            ...
            throw new RuntimeException("Erro ao ler os dados de funcionário!", e);
        } finally {
    ...
    public void delete(String idFuncionario) {
        ...
        try {
            ...
            stmt.execute();
            System.out.println("Funcionário apagado!");
        } catch (SQLException e) {
            throw new RuntimeException("Erro ao apagar funcionário", e);
        } finally {
            ConnectionDatabase.closeConnection(con, stmt);
        }
    }
    ...
    public ArrayList<Funcionario> search(String pesquisar) {
        ...
        try {
            stmt = con.prepareStatement(
                "SELECT * FROM Funcionario WHERE nomeFuncionario LIKE ? OR cpfFuncionario LIKE ?"
            );
